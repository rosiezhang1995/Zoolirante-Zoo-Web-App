                ...
                <div class="flex items-center justify-between h-16">
                    ...
                    <nav class="flex-1">
                        <ul class="flex justify-center space-x-6">
                            <li><a href="ticket-booking.html" class="text-zoo-darkbrown font-medium no-underline hover:underline">Tickets</a></li>
                            <li><a href="membership.html" class="text-zoo-darkbrown font-medium no-underline hover:underline">Memberships</a></li>
